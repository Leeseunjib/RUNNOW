...
const outputPath = 'C:\\Users\\USER\\.gemini\\antigravity-ide\\brain\\ca84e5b2-18c3-4af7-9489-c04ce439e8d4\\verify_4_species_clean.png';
const tempDir = 'C:\\Users\\USER\\AppData\\Local\\Temp\\Edge4Species_' + Date.now();
...
async function main() {
  ...
  console.log('3. Switching to Tamagotchi tab & Checking 4 species...');
  const evalCode = `
    (function() {
      ...
      // 칩 개수 및 텍스트 검사
      const chips = Array.from(document.querySelectorAll(".species-chip")).map(c => c.textContent.trim());
      ...
      return {
        ...
        chipsText: chips,
        avatarImg: document.querySelector("#t-avatar-container img")?.src
      };
    })();
  `;
